					...
					<div class="wrap-table100">
						<div class="table">
							...
							<div class="row1">
								...
								<div class="cell" data-title="Age"><a class="move" href='<c:out value="${list.board_bno}"/>'> <c:out value="${list.board_title}" /> 
							</a><span class="badge rounded-pill bg-warning"><c:out value="${list.reply_count}" /></span> </div>
